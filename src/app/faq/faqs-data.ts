...
export const FAQS: Faq[] = [
  ...
  { q: '¿Cuáles son los métodos de pago?', a: 'Aceptamos transferencia bancaria (subís el comprobante desde tu cuenta), pago en efectivo al retirar en el local o al despachar en micro, y cuenta corriente para clientes recurrentes y de confianza. Siempre hay un descuento con el pago en efectivo físico y transferencia.' },
  ...
  { q: '¿Qué hago si mi pago no fue confirmado?', a: 'Para pagos por transferencia, asegurate de subir el comprobante desde Mis Pedidos. Si ya pasaron varias horas y seguís sin novedades, contactanos.' },
