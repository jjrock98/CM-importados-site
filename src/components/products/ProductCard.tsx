...
import { Heart, Package, Bell, CheckCircle, Eye } from 'lucide-react';
      ...
      >
        ...
        <div className="relative">
          ...
          >
            ...
            {/* ✅ Ambos badges arriba a la izquierda (apilados) — antes
                "Stock limitado" vivía abajo a la izquierda, pero ahí lo tapa
                la barra de "Vista rápida" nueva (que en mobile queda siempre
                visible, no solo al pasar el mouse). */}
          ...
          {/* Vista rápida — abre el mismo modal que "Elegir pack" (todas las
              fotos, talles/colores, stock y precio) pero sin implicar que ya
              se está comprando. Siempre visible en mobile (no hay :hover en
              touch); en desktop aparece al pasar el mouse por la tarjeta. */}
          <button
            onClick={handleQuickView}
            aria-label={`Vista rápida de ${p.nombre}`}
            className="absolute inset-x-3 bottom-3 z-10 flex items-center justify-center gap-1.5
                       rounded-lg bg-white/95 py-2 text-xs font-semibold text-gray-800 backdrop-blur-sm
